...
json_file = open('C:/xampp/htdocs/Plant_Disease/Learned_weights_Corn/model.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("C:/xampp/htdocs/Plant_Disease/Learned_weights_Corn/model.h5")
...
import os
ls1=os.listdir('C:/xampp/htdocs/Plant_Disease/Learned_weights_Corn/color')
dic1={}
...
for idx,i in enumerate(ls1):
    dic1[i]=idx
    ls2=os.listdir('C:/xampp/htdocs/Plant_Disease/Learned_weights_Corn/color/'+i)
    for j in ls2:
...
def test_it():
    ...
    for i in xvap:
        ...
        score = {"x": dic2[int(xx)] }
        with open('C:/xampp/htdocs/Plant_Disease/Learned_weights_Corn/score.json', 'w') as out_json:
